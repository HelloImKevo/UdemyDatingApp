...
namespace API.Controllers
{
    ...
    public class UsersController : BaseApiController
    {
        ...
        public async Task<ActionResult<PagedList<MemberDto>>> GetUsers([FromQuery] UserParams userParams)
        {
            ...
            // Need to iron out some bugs with Age selection before restoring this functionality.
        ...
        public async Task<ActionResult> SetMainPhoto(int photoId)
        {
            ...
            // Change existing main to "Not Main", and set the specified photo
            // to the new "Main Photo".
        ...
        public async Task<ActionResult> DeletePhoto(int photoId)
        {
            ...
            // TODO: Allow users to Delete their main photo, and substitute it with
            // a generic user avatar placeholder.
